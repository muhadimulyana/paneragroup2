...
<html lang="en">
    ...
    <head>
        ...
        <link rel="stylesheet" href="https://unicons.iconscout.com/release/v2.1.9/<?= base_url(); ?>assets/front/css/unicons.css">
        <!-- Slider -->               
    ...
    <body>
            ...
            <div class="container">
                ...
                <div>
                    <a class="logo" href="index.html">
                        <img src="<?= base_url(); ?>assets/front/images/logo-dark.png" class="l-dark" height="24" alt="">
                        <img src="<?= base_url(); ?>assets/front/images/logo-light.png" class="l-light" height="24" alt="">
                    </a>
                </div>                 
        ...
        <!-- Hero Start -->
        <section class="bg-half-170 d-table w-100" style="background: url('<?= base_url(); ?>assets/front/images/travel/bg.jpg') center center;">
                    ...
                    <div class="col-md-12 mt-4 pt-2">
                        <div id="six-slide" class="owl-carousel owl-theme">
                            <div class="popular-tour rounded-md position-relative overflow-hidden mx-3">
                                <img src="<?= base_url(); ?>assets/front/images/travel/dubai.jpg" class="img-fluid" alt="">
                            ...
                            <div class="popular-tour rounded-md position-relative overflow-hidden mx-3">
                                <img src="<?= base_url(); ?>assets/front/images/travel/thailand.jpg" class="img-fluid" alt="">
                                <div class="overlay-work bg-dark"></div>
                                <div class="content">
                            ...
                            <div class="popular-tour rounded-md position-relative overflow-hidden mx-3">
                                <img src="<?= base_url(); ?>assets/front/images/travel/india.jpg" class="img-fluid" alt="">
                                <div class="overlay-work bg-dark"></div>
                                <div class="content">
                            ...
                            <div class="popular-tour rounded-md position-relative overflow-hidden mx-3">
                                <img src="<?= base_url(); ?>assets/front/images/travel/london.jpg" class="img-fluid" alt="">
                                <div class="overlay-work bg-dark"></div>
                                <div class="content">
                            ...
                            <div class="popular-tour rounded-md position-relative overflow-hidden mx-3">
                                <img src="<?= base_url(); ?>assets/front/images/travel/paris.jpg" class="img-fluid" alt="">
                                <div class="overlay-work bg-dark"></div>
                                <div class="content">
                            ...
                            <div class="popular-tour rounded-md position-relative overflow-hidden mx-3">
                                <img src="<?= base_url(); ?>assets/front/images/travel/singapore.jpg" class="img-fluid" alt="">
                                <div class="overlay-work bg-dark"></div>
                                <div class="content">
        ...
        <section class="section bg-light">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-5 col-md-6">
                        <div class="card blog rounded border-0 shadow overflow-hidden">
                            <div class="position-relative">
                                <img src="<?= base_url(); ?>assets/front/images/travel/1.jpg" class="card-img-top" alt="...">
                                <div class="overlay rounded-top bg-dark"></div>
                            </div>
                            <div class="card-body content">
                                <h5><a href="javascript:void(0)" class="card-title title text-dark">Conversations, Feedback, Recognition</a></h5>
                    ...
                    <div class="col-lg-7 col-md-6 mt-4 mt-sm-0 pt-2 pt-sm-0">
                        <div class="section-title ml-lg-4">
                            ...
                            <a href="javascript:void(0)" class="mt-3 h6 text-primary">Search Destination <i class="mdi mdi-chevron-right"></i></a>
                        </div>
                    </div><!--end col-->
                </div><!--end row-->
            </div><!--end container-->
            ...
            <div class="container mt-100 mt-60">
                <div class="row align-items-center">
                    <div class="col-lg-5 col-md-6 order-1 order-md-2">
                        <img src="<?= base_url(); ?>assets/front/images/travel/3.jpg" class="img-fluid rounded shadow-md" alt="">
                    </div><!--end col-->
            ...
            <div class="container mt-100 mt-60">
                <div class="row align-items-center">
                    <div class="col-lg-5 col-md-6">
                        <img src="<?= base_url(); ?>assets/front/images/travel/2.jpg" class="img-fluid rounded shadow-md" alt="">
                    </div><!--end col-->
                    ...
                    <div class="col-lg-12 mt-4">
                        <div id="customer-testi" class="owl-carousel owl-theme">
                            <div class="media customer-testi m-2">
                                <img src="<?= base_url(); ?>assets/front/images/client/01.jpg" class="avatar avatar-small mr-3 rounded shadow" alt="">
                            ...
                            <div class="media customer-testi m-2">
                                <img src="<?= base_url(); ?>assets/front/images/client/02.jpg" class="avatar avatar-small mr-3 rounded shadow" alt="">
                                <div class="media-body content p-3 shadow rounded bg-white position-relative">
                                    <ul class="list-unstyled mb-0">
                                        <li class="list-inline-item"><i class="mdi mdi-star text-warning"></i></li>
                                        <li class="list-inline-item"><i class="mdi mdi-star text-warning"></i></li>
                            ...
                            <div class="media customer-testi m-2">
                                <img src="<?= base_url(); ?>assets/front/images/client/03.jpg" class="avatar avatar-small mr-3 rounded shadow" alt="">
                                <div class="media-body content p-3 shadow rounded bg-white position-relative">
                                    <ul class="list-unstyled mb-0">
                                        <li class="list-inline-item"><i class="mdi mdi-star text-warning"></i></li>
                                        <li class="list-inline-item"><i class="mdi mdi-star text-warning"></i></li>
                            ...
                            <div class="media customer-testi m-2">
                                <img src="<?= base_url(); ?>assets/front/images/client/04.jpg" class="avatar avatar-small mr-3 rounded shadow" alt="">
                                <div class="media-body content p-3 shadow rounded bg-white position-relative">
                                    <ul class="list-unstyled mb-0">
                                        <li class="list-inline-item"><i class="mdi mdi-star text-warning"></i></li>
                                        <li class="list-inline-item"><i class="mdi mdi-star text-warning"></i></li>
                            ...
                            <div class="media customer-testi m-2">
                                <img src="<?= base_url(); ?>assets/front/images/client/05.jpg" class="avatar avatar-small mr-3 rounded shadow" alt="">
                                <div class="media-body content p-3 shadow rounded bg-white position-relative">
                                    <ul class="list-unstyled mb-0">
                                        <li class="list-inline-item"><i class="mdi mdi-star text-warning"></i></li>
                                        <li class="list-inline-item"><i class="mdi mdi-star text-warning"></i></li>
                            ...
                            <div class="media customer-testi m-2">
                                <img src="<?= base_url(); ?>assets/front/images/client/06.jpg" class="avatar avatar-small mr-3 rounded shadow" alt="">
                                <div class="media-body content p-3 shadow rounded bg-white position-relative">
                                    <ul class="list-unstyled mb-0">
                                        <li class="list-inline-item"><i class="mdi mdi-star text-warning"></i></li>
                                        <li class="list-inline-item"><i class="mdi mdi-star text-warning"></i></li>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-6 mt-4 mt-sm-0 pt-2 pt-sm-0">
                        <ul class="list-unstyled text-sm-right mb-0">
                            <li class="list-inline-item"><a href="javascript:void(0)"><img src="<?= base_url(); ?>assets/front/images/payments/american-ex.png" class="avatar avatar-ex-sm" title="American Express" alt=""></a></li>
                            <li class="list-inline-item"><a href="javascript:void(0)"><img src="<?= base_url(); ?>assets/front/images/payments/discover.png" class="avatar avatar-ex-sm" title="Discover" alt=""></a></li>
                            <li class="list-inline-item"><a href="javascript:void(0)"><img src="<?= base_url(); ?>assets/front/images/payments/master-card.png" class="avatar avatar-ex-sm" title="Master Card" alt=""></a></li>
                            <li class="list-inline-item"><a href="javascript:void(0)"><img src="<?= base_url(); ?>assets/front/images/payments/paypal.png" class="avatar avatar-ex-sm" title="Paypal" alt=""></a></li>
                            <li class="list-inline-item"><a href="javascript:void(0)"><img src="<?= base_url(); ?>assets/front/images/payments/visa.png" class="avatar avatar-ex-sm" title="Visa" alt=""></a></li>
                        </ul>
                    </div><!--end col-->
                </div><!--end row-->
            </div><!--end container-->
