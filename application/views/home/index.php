					...
					<div class="col-lg-7 col-md-7">
						<div class="title-heading position-relative mt-5" style="z-index: 1;">
							...
							<div class="watch-video mt-4 pt-2">
								<a href="<?= site_url() . $row->URL; ?>" class="btn btn-primary mouse-down"><i
			...
			<div class="col-lg-8 col-md-8 col-12 mt-4 mt-sm-0 pt-2 pt-sm-0">
				<div class="section-title">
					...
					<!-- <p class="text-muted para-desc mb-0">Kami tetap berkomitmen untuk memenuhi kebutuhan Anda,
						...
						plastik kami.</p> -->
					<p class="text-muted para-desc mb-0">Kami tetap berkomitmen untuk memberikan yang terbaik dalam memenuhi kebutuhan Anda, silahkan menghhubungi nomor telepon kami untuk mendapatkan contact distributor produk kami.</p>
					<div class="d-inline-block">
						<div class="pt-4 d-flex align-items-center border-top">
							<i data-feather="phone" class="fea icon-md mr-2 text-primary"></i>
							<div class="content">
								<a href="tel:+62215453087"><h4 class="mb-0 text-primary" style="text-decoration: underline">021-545 3087</h4></a>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="row justify-content-center">
			<div class="col-12 text-center">
				<div class="section-title">
					...
					<h5 class="text-light para-desc para-dark mx-auto font-weight-light">Kami adalah salah satu grup perusahaan terkemuka di Indonesia yang bergerak di pendauran ulang limbah plastik, dan manufaktur kantong plastik dengan merek LOCO</h5>
				</div>
			</div>
			<!--end col-->
		</div>
...
<!-- News Start -->
<section class="section pt-5 pt-md-5 bg-primary">
	<div class="container">
		<div class="row justify-content-center">
			<div class="col-12 text-center">
				<div class="section-title mb-4 pb-2">
				...
				<div class="card blog rounded border-0 shadow">
					...
					<div class="card-body content">
						...
						<div class="post-meta d-flex justify-content-between mt-3">
							<a href="<?= base_url('news/detail'); ?>" class="text-muted readmore">Selengkapnya <i
