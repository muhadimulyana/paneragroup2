				...
				<div class="row">
					<div class="col-lg-6 col-md-12 mb-4 pb-2">
						<div class="card blog rounded border-0 shadow">
							...
							<div class="author">
								<small class="text-light user d-block"><i class="mdi mdi-account"></i> Muhamad
									Adi</small>
								...
								<div class="clearfix post-recent">
									<div class="post-recent-thumb float-left">
										<!-- <a href="jvascript:void(0)">
											<img alt="img" src="<?= base_url(); ?>assets/images/news/1.jpg"
												class="img-fluid rounded">
										</a> -->
										<a href="javascript:void" class="img-fluid rounded"
