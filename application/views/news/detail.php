...
<section class="bg-half d-table w-100"
	style="background: url('<?= base_url(); ?>assets/images/news/media-online.jpg') center; background-size: cover;  background-attachment: fixed;">
					...
					<div class="page-next">
						<nav aria-label="breadcrumb" class="d-inline-block">
							<ul class="breadcrumb bg-white rounded shadow mb-0">
								...
								<li class="breadcrumb-item"><a href="javascript:void">Media & Informations</a>
								</li>
								<li class="breadcrumb-item"><a href="javascript:void">News</a>
								</li>
				...
				<div class="row">
					<div class="col-md-2 d-none d-md-block">
						<ul class="list-unstyled text-center sticky-bar social-icon mb-0">
							...
							<li><a href="javascript:void(0)" class="rounded"><i data-feather="instagram"
										class="fea icon-sm fea-social"></i></a></li>
							<li><a href="javascript:void(0)" class="rounded"><i data-feather="twitter"
										class="fea icon-sm fea-social"></i></a></li>
					...
					<div class="col-md-10">
						...
						<img src="<?= base_url(); ?>assets/images/news/2.jpeg" class="img-fluid rounded-md shadow"
							alt="">
						<span class="badge badge-pill badge-primary mt-3"> Improvement </span>
						<h5 class="mt-3">Pelatihan Manajemen PAN ERA Group</h5>
						...
						<p class="mt-3">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
							...
							laborum.</p>
						<p class="mt-3">Aenean et tortor at risus viverra. Luctus venenatis lectus magna fringilla.
							Euismod in pellentesque massa placerat duis ultricies lacus sed. Ultrices tincidunt arcu non
							sodales neque. Proin nibh nisl condimentum id venenatis a condimentum vitae. Sed nisi lacus
							sed viverra tellus in hac habitasse. </p>
						<p class="mt-3">Consectetur adipiscing elit pellentesque habitant morbi tristique. Velit egestas
							dui id ornare arcu odio ut sem. Porttitor eget dolor morbi non arcu risus quis varius quam.
							Porttitor leo a diam sollicitudin tempor id. Luctus venenatis lectus magna fringilla urna
							porttitor. Arcu non sodales neque sodales. Leo vel fringilla est ullamcorper. Augue neque
							gravida in fermentum et.</p>
						<p class="mt-3">Consectetur adipiscing elit pellentesque habitant morbi tristique. Velit egestas
							dui id ornare arcu odio ut sem. Porttitor eget dolor morbi non arcu risus quis varius quam.
							Porttitor leo a diam sollicitudin tempor id. Luctus venenatis lectus magna fringilla urna
							porttitor. Arcu non sodales neque sodales. Leo vel fringilla est ullamcorper. Augue neque
							gravida in fermentum et. Convallis aenean et tortor at risus viverra. Nam at lectus urna
							duis convallis convallis. Aliquet nibh praesent tristique magna sit amet purus gravida.
							Praesent elementum facilisis leo vel. Fringilla urna porttitor rhoncus dolor purus non.
							Dolor magna eget est lorem. Vitae aliquet nec ullamcorper sit amet risus. Morbi non arcu
							risus quis varius quam quisque id diam. Odio morbi quis commodo odio. Pretium viverra
							suspendisse potenti nullam ac tortor. Egestas fringilla phasellus faucibus scelerisque
						...
						<ul class="media-list list-unstyled mb-0">
							<li class="mt-4">
								<div class="d-flex justify-content-between">
									<div class="media align-items-center">
										<a class="pr-3" href="#">
											<img src="<?= base_url(); ?>assets/images/client/01.jpg"
								...
								<div class="mt-3">
									<p class="text-muted font-italic p-3 bg-light rounded">" There are many variations
							...
							<li class="mt-4">
								<div class="d-flex justify-content-between">
									<div class="media align-items-center">
										<a class="pr-3" href="#">
											<img src="<?= base_url(); ?>assets/images/client/02.jpg"
												class="img-fluid avatar avatar-md-sm rounded-circle shadow" alt="img">
										</a>
										<div class="commentor-detail">
											<h6 class="mb-0"><a href="javascript:void(0)"
							...
							<li class="mt-4">
								<div class="d-flex justify-content-between">
									<div class="media align-items-center">
										<a class="pr-3" href="#">
											<img src="<?= base_url(); ?>assets/images/client/03.jpg"
												class="img-fluid avatar avatar-md-sm rounded-circle shadow" alt="img">
										</a>
										<div class="commentor-detail">
											<h6 class="mb-0"><a href="javascript:void(0)"
								...
								<ul class="list-unstyled pl-4 pl-md-5 sub-comment">
									<li class="mt-4">
										...
										<div class="mt-3">
											<p class="text-muted font-italic p-3 bg-light rounded">" There are many
