						...
						<div class="post-meta mt-3">
							<ul class="list-unstyled mb-0">
								<li class="list-inline-item mr-2"><a href="javascript:void(0)"
										class="text-muted like"><i class="mdi mdi-heart-outline mr-1"></i>33</a></li>
						...
						<div class="row">
							<div class="col-lg-6 mt-4 pt-2">
								<div class="card blog rounded border-0 shadow">
									...
									<div class="card-body content">
										<h5><a href="javascript:void(0)" class="card-title title text-dark">Design your
									...
									<div class="author">
										<small class="text-light user d-block"><i class="mdi mdi-account"></i> Calvin
											Carlo</small>
										<small class="text-light date"><i class="mdi mdi-calendar-check"></i> 13th
											August, 2019</small>
									</div>
								</div>
							</div>
					...
					<div class="card-body">
						...
						<form class="mt-3">
							<div class="row">
								...
								<div class="col-md-12">
									<div class="send">
										<button type="submit" class="btn btn-primary btn-block text-blue">Send
											Message</button>
									</div>
								</div>
								<!--end col-->
				...
				<div class="card border-0 sidebar sticky-bar rounded shadow">
					<div class="card-body">
						...
						<div class="widget mb-4 pb-2">
							...
							<a href="#" class="btn btn-soft-primary btn-sm btn-block text-light">Company
								Profile <i class="mdi mdi-arrow-right"></i></a>
							<a href="#" class="btn btn-soft-primary btn-sm btn-block text-light">Vision &
								Mission <i class="mdi mdi-arrow-right"></i></a>
							<a href="#" class="btn btn-soft-primary btn-sm btn-block text-light">PT. Elite
								Recycling
								Indonesia <i class="mdi mdi-arrow-right"></i></a>
							<a href="#" class="btn btn-soft-primary btn-sm btn-block text-light">PT. Elastis
								Reka
								Aktif <i class="mdi mdi-arrow-right"></i></a>
							<a href="#" class="btn btn-soft-primary btn-sm btn-block text-light">PT. Eterna
								Persada
								Indonesia <i class="mdi mdi-arrow-right"></i></a>
						</div>
						<!-- CATAGORIES -->
